    ...
    public CommandLineRunner initData() {
        return args -> {
            if (productRepository.count() == 0) {
                ...
                p6.setName("The Pragmatic Programmer");
